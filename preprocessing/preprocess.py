...
class Preprocess:
  ...
  def skull_strip(self,src_path,dst_path):
  ...
  def bias_correction(self,src_path,dst_path):
    try:
  ...
  def segmentation(self,src_path,dst_path):
  ...
  def final_two_dimensional_image(self,src_path,dst_path):
